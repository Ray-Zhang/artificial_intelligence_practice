...
def uniformCostSearch(problem):
    ...
    while True:
        ...
        if currentState not in closed:
            closed.add(currentState)
            for successor in problem.getSuccessors(currentState):
                fringe.push((successor[0], actions + [successor[1]], cost + successor[2]), cost + successor[2])
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while True:
        ...
        if currentState not in closed:
            closed.add(currentState)
            for successor in problem.getSuccessors(currentState):
                fringe.push((successor[0], actions + [successor[1]], cost + successor[2]), cost + successor[2] + heuristic(successor[0], problem))
